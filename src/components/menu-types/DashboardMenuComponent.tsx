                    ...
                    {widget.type === 'progress' && (
                      <div className="space-y-2">
                        <div className="flex items-center justify-between text-sm">
                          <span>
                            {widget.config.current || 0}
                            {widget.config.unit}
                          </span>
                          <span>
                            {widget.config.target || 100}
                            {widget.config.unit}
                          </span>
                        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>
                • <strong>카운터:</strong> 일일 목표나 습관 추적에 활용하세요
              </li>
              <li>
                • <strong>진행률:</strong> 장기 프로젝트나 학습 진도를
                시각화하세요
              </li>
              <li>
                • <strong>목표:</strong> 개인 목표를 설정하고 달성률을
                관리하세요
              </li>
              <li>
                • <strong>캘린더:</strong> 개인 일정과 중요한 날짜를 기록하세요
              </li>
            </ul>
          </div>
        </div>
